...
categories: []
tags: []
lastmod: '2020-10-23T17:03:23+08:00'
keywords: []
description: ''
comment: no
toc:
...
library(ggsci)
library(ggpubr)
# If you get an error message saying: No such file or directory install the package first then run library
# If you are new to R then you can install the following packages
#install.packages(c("landscapemetrics","raster","sf","sp","tidyverse","rgdal", "scales","ggsci","plotrix","plyr"))
```
...
That is how it works. We got some metrics but what do they mean. You can open the [**full document of Landscapemetrics here**](https://cran.r-project.org/web/packages/landscapemetrics/landscapemetrics.pdf) and have a look at everything that the package can do.
