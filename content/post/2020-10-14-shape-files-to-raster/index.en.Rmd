...
3. Draw three graphs: one boxplot graph for your 6 the landscapes metrics, one bar graph for the classes with error bars showing the standard deviation, and one for the patch level metric with error bars showing standard error.
